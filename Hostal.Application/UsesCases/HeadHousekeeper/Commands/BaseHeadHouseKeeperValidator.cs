...
public class BaseHeadHouseKeeperValidator : AbstractValidator<HeadHouseKeeperCommandDto>
{
    public BaseHeadHouseKeeperValidator()
    {
        ...
        RuleFor(x => x.Name)
            .NotEmpty()
            .WithMessage("Ingrese el nombre de la ama de llaves.")
            .Length(2, 100)
        ...
        RuleFor(x => x.LastName)
            .NotEmpty()
            .WithMessage("Ingrese los apellidos de la ama de llaves.")
            .Length(2, 100)
        ...
        RuleFor(x => x.Phone)
            .NotEmpty()
            .WithMessage("Ingrese el número de teléfono de la ama de llaves.")
            .Length(7, 20)
